...
public class RNAMapGeolocationModule extends ReactContextBaseJavaModule {
   ...
   */
  public void setLocationProtocol(
  ...
  public void setGeoLanguage(String language) {
    ...
    option.setGeoLanguage(
      AMapLocationClientOption.GeoLanguage.valueOf(language)
    );
    client.setLocationOption(option);
  }
  ...
  public void setLocationMode(String mode) {
    ...
    option.setLocationMode(
      AMapLocationClientOption.AMapLocationMode.valueOf(mode)
    );
    client.setLocationOption(option);
  }
  ...
  private WritableMap toJSON(AMapLocation location) {
    ...
    if (location.getErrorCode() == AMapLocation.LOCATION_SUCCESS) {
      ...
      qualityReportMap.putInt(
        "gpsSatellites",
        aMapLocationQualityReport.getGPSSatellites()
      );
      qualityReportMap.putInt(
        "gpsStatus",
      ...
      qualityReportMap.putDouble(
        "netUseTime",
        aMapLocationQualityReport.getNetUseTime()
      );
      qualityReportMap.putString(
        "networkType",
        aMapLocationQualityReport.getNetworkType()
      );
      ...
      qualityReportMap.putBoolean(
        "isWifiAble",
        aMapLocationQualityReport.isWifiAble()
      );
